...
class MemberAuthentication {
    ...
    showTierSelection(email) {
        ...
        const tiers = [
            { name: 'bronze', icon: 'fas fa-medal', title: 'Bronze Member', desc: 'Basic exclusive recipes', price: '₹99/month' },
            { name: 'silver', icon: 'fas fa-trophy', title: 'Silver Member', desc: 'Premium recipes + Early access', price: '₹199/month' },
            { name: 'gold', icon: 'fas fa-crown', title: 'Gold Member', desc: 'All content + Live sessions', price: '₹299/month' }
        ];
